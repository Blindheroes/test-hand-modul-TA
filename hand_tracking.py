...
class HandTracker:
    def __init__(self, use_threshold_adaptation=True, use_temporal_filtering=True):
        ...
        self.hand_depth = 0
        # Smoothing filter for depth values
    ...
    def visualize_hand_depth(self, frame):
        ...
        depth_range = max(0.001, self.depth_max - self.depth_min)
        normalized_depth = min(
            100, max(0, 100 * (self.hand_depth - self.depth_min) / depth_range))
